...
class AsciiEffectImpl extends Effect {
  ...
  update(_renderer: unknown, _inputBuffer: unknown, deltaTime: number) {
    const targetFPS = (this.uniforms.get("targetFPS") as Uniform).value as number
    ...
    ;(this.uniforms.get("time") as Uniform).value = _time
    ;(this.uniforms.get("cellSize") as Uniform).value = _cellSize
    ;(this.uniforms.get("invert") as Uniform).value = _invert
    ;(this.uniforms.get("colorMode") as Uniform).value = _colorMode
    ;(this.uniforms.get("asciiStyle") as Uniform).value = _asciiStyle
    ;(this.uniforms.get("resolution") as Uniform).value = _resolution
    ;(this.uniforms.get("mousePos") as Uniform).value = _mousePos
  }
}
