...
const copy = {
  ...
  es: {
    ...
    githubTitle: "Casi todo el crecimiento de estrellas de la organización vino de Petdex.",
    githubBody: "Petdex creció de 70 a 3,288 estrellas mientras Crafter Station pasó de 870 a 4,197. El cálculo es (3,288 - 70) / (4,197 - 870) = 96.72%.",
    packageEyebrow: "Señal del paquete",
    packageTitle: "De 380 a 28,875 descargas en diez períodos semanales.",
    packageBody: "La API pública de npm coincide con la serie acumulada de OSSCAR. El crecimiento real es 75.99x. OSSCAR muestra 28.9x porque normaliza el baseline de proyectos nuevos a 1,000 descargas.",
