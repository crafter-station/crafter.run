...
export const services = [
  ...
  },
  {
    ...
    body: {
      ...
      es: "Interfaces disenadas y construidas por la misma persona. Motion, 3D y WebGL, sistemas de diseno que aguantan, y las interacciones chicas que nadie deberia notar.",
