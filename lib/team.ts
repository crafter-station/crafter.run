...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: {
      en: "I refine frontend products: features, edge cases, and flows that work in production. Frontend engineer building interfaces that work for real users—with ownership on every project and care in every release.",
      es: "Refino productos frontend: features, casuísticas y flujos que funcionan en producción. Ingeniero frontend construyendo interfaces que funcionan para usuarios reales—con ownership en cada proyecto y cuidado en cada entrega.",
      pt: "Refino produtos frontend: features, casos de borda e fluxos que funcionam em produção. Engenheiro frontend construindo interfaces que funcionam para usuarios reais—com ownership em cada projeto e cuidado em cada entrega.",
    },
    ...
    listening: {
      ...
      url: "https://www.youtube.com/watch?v=pSUAxldecfA",
    },
    stack: [
      { category: "Languages", items: ["JavaScript", "TypeScript", "Python", "Dart"] },
      { category: "Frontend", items: ["React", "Next.js", "Tailwind", "Bootstrap", "MUI", "Flutter"] },
